    ...
    >
      ...
      <div className="relative flex justify-between items-center px-6 py-4">
        ...
        <div className="md:hidden flex items-center text-xs gap-2 z-30">
          {isCareerPage ? (
            <HashLink smooth to="#career-connect">
        ...
        <div className="hidden md:flex items-center gap-8 font-medium z-30">
          <HashLink smooth to="/#hero" className="hover:text-red-500 transition">
            Home
          </HashLink>
          <HashLink smooth to="/#about" className="hover:text-red-500 transition">
            About
          </HashLink>
          <HashLink
            smooth
          ...
          <HashLink smooth to="/#team" className="hover:text-red-500 transition">
            Our Team
          </HashLink>
